webpackJsonp([0, 3], {
        ...
        (function (module, __webpack_exports__, __webpack_require__) {
                ...
                BinaryAjax = function () {
                    ...
                    function n(t, n, r, o, a, i) {
                        ...
                        if (s) {
                            ...
                            o && !a && (u = o[0]);
                            var c = 0;
                            o && (c = o[1] - o[0] + 1), n && ("undefined" != typeof s.onload ? s.onload = function () {
                                ...
                                if (4 == s.readyState) {
                                    if ("200" == s.status || "206" == s.status || "0" == s.status) {
                                        var e = {
                                            status: s.status,
                                            binaryResponse: new BinaryFile("unknown" == typeof s.responseBody ? s.responseBody : s.responseText, u, c),
                                            fileSize: i || s.getResponseHeader("Content-Length")
                                        };
                                        n(e);
                                    } else r && r();
                                    s = null;
                    ...
                    return function (e, r, o, a) {
                        a ? t(e, function (t) {
                            ...
                            i = a[0], a[0] < 0 && (i += u), s = i + a[1] - 1, n(e, r, o, [i, s], "bytes" == c, u);
                        }) : n(e, r, o);
                    };
                }();
            document.write("<script type='text/vbscript'>\r\nFunction IEBinary_getByteAt(strBinary, iOffset)\r\n\tIEBinary_getByteAt = AscB(MidB(strBinary, iOffset + 1, 1))\r\nEnd Function\r\nFunction IEBinary_getBytesAt(strBinary, iOffset, iLength)\r\n  Dim aBytes()\r\n  ReDim aBytes(iLength - 1)\r\n  For i = 0 To iLength - 1\r\n   aBytes(i) = IEBinary_getByteAt(strBinary, iOffset + i)\r\n  Next\r\n  IEBinary_getBytesAt = aBytes\r\nEnd Function\r\nFunction IEBinary_getLength(strBinary)\r\n\tIEBinary_getLength = LenB(strBinary)\r\nEnd Function\r\n</script>\r\n"),
                    ...
                    e.EXIF = function () {
                        ...
                        function n(e) {
                            ...
                            for (var t, n = 2, r = e.getLength(); n < r;) {
                                if (255 != e.getByteAt(n)) return l && console.log("Not a valid marker at offset " + n + ", found: " + e.getByteAt(n)), !1;
                                if (t = e.getByteAt(n + 1), 22400 == t) return l && console.log("Found 0xFFE1 marker"), a(e, n + 4, e.getShortAt(n + 2, !0) - 2);
                                if (225 == t) return l && console.log("Found 0xFFE1 marker"), a(e, n + 4, e.getShortAt(n + 2, !0) - 2);
                        ...
                        function o(e, t, n, r, o) {
                            var a,
                                ...
                                g = e.getLongAt(t + 4, o),
                                h = e.getLongAt(t + 8, o) + n;
                            switch (l) {
                                case 1:
                                case 7:
                                    if (1 == g) return e.getByteAt(t + 8, o);
                                    for (a = g > 4 ? h : t + 8, i = [], u = 0; u < g; u++) {
                                        i[u] = e.getByteAt(a + u);
                                    }
                                    return i;
                                case 2:
                                    return a = g > 4 ? h : t + 8, e.getStringAt(a, g - 1);
                                case 3:
                                    if (1 == g) return e.getShortAt(t + 8, o);
                                    for (a = g > 2 ? h : t + 8, i = [], u = 0; u < g; u++) {
                                ...
                                case 4:
                                    ...
                                    return i;
                                case 5:
                                    if (1 == g) return c = e.getLongAt(h, o), d = e.getLongAt(h + 4, o), s = new Number(c / d), s.numerator = c, s.denominator = d, s;
                                    for (i = [], u = 0; u < g; u++) {
                                ...
                                case 9:
                                    ...
                                    return i;
                                case 10:
                                    if (1 == g) return e.getSLongAt(h, o) / e.getSLongAt(h + 4, o);
                                    for (i = [], u = 0; u < g; u++) {
                        ...
                        function a(e, t) {
                            if ("Exif" != e.getStringAt(t, 4)) return l && console.log("Not valid EXIF data! " + e.getStringAt(t, 4)), !1;
                            var n,
                                o,
                                a,
                                i,
                            ...
                            if (18761 == e.getShortAt(u)) n = !1;
                                ...
                                if (19789 != e.getShortAt(u)) return l && console.log("Not valid TIFF data! (no 0x4949 or 0x4D4D)"), !1;
                                n = !0;
                            }
                            if (42 != e.getShortAt(u + 2, n)) return l && console.log("Not valid TIFF data! (no 0x002A)"), !1;
                            if (8 != e.getLongAt(u + 4, n)) return l && console.log("Not valid TIFF data! (First offset not 8)", e.getShortAt(u + 4, n)), !1;
                            if (o = r(e, u, u + 8, h, n), o.ExifIFDPointer) {
                                i = r(e, u, u + o.ExifIFDPointer, g, n);
                                for (a in i) {
                                    switch (a) {
                                        case "LightSource":
                                        case "Flash":
                                        ...
                                        case "ComponentsConfiguration":
                                            i[a] = p.Components[i[a][0]] + p.Components[i[a][1]] + p.Components[i[a][2]] + p.Components[i[a][3]];
                                    }
                                    o[a] = i[a];
                                }
                            }
                            if (o.GPSInfoIFDPointer) {
                                s = r(e, u, u + o.GPSInfoIFDPointer, f, n);
                                for (a in s) {
                                    switch (a) {
                                        case "GPSVersionID":
                ...
                function (e) {
                    ...
                    var n = "canvasResize",
                        r = {
                            newsize: function newsize(e, t, n, r, o) {
                                var a = o ? "h" : "";
                                if (n && e > n || r && t > r) {
                                    var i = e / t;
                                    (i >= 1 || 0 === r) && n && !o ? (e = n, t = n / i >> 0) : o && i <= n / r ? (e = n, t = n / i >> 0, a = "w") : (e = r * i >> 0, t = r);
                                }
                                return {
                                    width: e,
                                    height: t,
                            ...
                            dataURLtoBlob: function dataURLtoBlob(e) {
                                ...
                                return i ? (i = new(window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder)(), i.append(r), i.getBlob(t)) : i = new Blob([r], {
                                    type: t
                                });
                            },
                            ...
                            detectVerticalSquash: function detectVerticalSquash(e, t, n) {
                                ...
                                var o = r.getContext("2d");
                                o.drawImage(e, 0, 0);
                                for (var a = o.getImageData(0, 0, 1, n).data, i = 0, s = n, u = n; u > i;) {
                                    var c = a[4 * (u - 1) + 3];
                                    0 === c ? s = u : i = u, u = s + i >> 1;
                                }
                                var d = u / n;
                            ...
                            extend: function extend() {
                                var e = arguments[0] || {},
                                    ...
                                    n = arguments.length,
                                    o = !1;
                                e.constructor === Boolean && (o = e, e = arguments[1] || {}), 1 === n && (e = this, t = 0);
                                for (var a; t < n; t++) {
                        ...
                        init: function init() {
                            ...
                            o.onloadend = function (t) {
                                var o = t.target.result,
                                    ...
                                    u = new Image();
                                u.onload = function (t) {
                                    var a = s.Orientation || 1;
                                    a = r.rotate(a, e.options.rotate);
                                    var i = a >= 5 && a <= 8 ? r.newsize(u.height, u.width, e.options.width, e.options.height, e.options.crop) : r.newsize(u.width, u.height, e.options.width, e.options.height, e.options.crop),
                                        c = u.width,
                                        d = u.height,
                                        l = i.width,
                                        g = i.height,
                                        ...
                                        f = h.getContext("2d");
                                    f.save(), r.transformCoordinate(h, l, g, a), r.detectSubsampling(u) && (c /= 2, d /= 2);
                                    var p = 1024,
                                        S = document.createElement("canvas");
                                    S.width = S.height = p;
                                    for (var m = S.getContext("2d"), y = r.detectVerticalSquash(u, c, d), w = 0; w < d;) {
                                        for (var A = w + p > d ? d - w : p, B = 0; B < c;) {
                                            var F = B + p > c ? c - B : p;
                                            m.clearRect(0, 0, p, p), m.drawImage(u, -B, -w);
                                            var v = Math.floor(B * l / c),
                                                P = Math.ceil(F * l / c),
                                                C = Math.floor(w * g / d / y),
                                                b = Math.ceil(A * g / d / y);
                                            f.drawImage(S, 0, 0, F, A, v, C, P, b), B += p;
                                        }
                                        w += p;
                                    }
                                    f.restore(), S = m = null;
                                    var D = document.createElement("canvas");
                                    D.width = "h" === i.cropped ? g : l, D.height = "w" === i.cropped ? l : g;
                                    var I = "h" === i.cropped ? .5 * (g - l) : 0,
                                        L = "w" === i.cropped ? .5 * (l - g) : 0;
                                    var newctx = D.getContext("2d");
                                    newctx.drawImage(h, I, L, l, g);
                                    var R = o.length > n ? D.toDataURL("image/jpeg", .1) : o;
                                    e.options.callback(R, D.width, D.height);
                                }, u.src = o;
                            }, o.readAsDataURL(t);
                        }
    ...
    8:
        ...
        (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1_jsLib_imgResize__ = __webpack_require__(10);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__index_less__ = __webpack_require__(11);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__index_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__index_less__);
